...
bool my_joystick_msgs__msg__joystick__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // lx
    ...
    ros_message->lx = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // ly
    ...
    assert(PyLong_Check(field));
    ros_message->ly = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // rx
  ...
  {  // dx
    ...
    assert(PyLong_Check(field));
    ros_message->dx = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // dy
    ...
    assert(PyLong_Check(field));
    ros_message->dy = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // l2
    ...
    assert(PyLong_Check(field));
    ros_message->l2 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // r2
    ...
    assert(PyLong_Check(field));
    ros_message->r2 = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // a
...
PyObject * my_joystick_msgs__msg__joystick__convert_to_py(void * raw_ros_message)
{
  ...
  {  // lx
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->lx);
    {
  ...
  {  // ly
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->ly);
    {
  ...
  {  // dx
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->dx);
    {
  ...
  {  // dy
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->dy);
    {
  ...
  {  // l2
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->l2);
    {
  ...
  {  // r2
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->r2);
    {
