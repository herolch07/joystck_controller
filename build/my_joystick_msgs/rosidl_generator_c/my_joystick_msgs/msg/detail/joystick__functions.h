...
#ifndef MY_JOYSTICK_MSGS__MSG__DETAIL__JOYSTICK__FUNCTIONS_H_
#define MY_JOYSTICK_MSGS__MSG__DETAIL__JOYSTICK__FUNCTIONS_H_
...
#include "my_joystick_msgs/msg/rosidl_generator_c__visibility_control.h"
 ...
 * )) before or use
 * my_joystick_msgs__msg__Joystick__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_my_joystick_msgs
bool
 ...
 * calls
 * my_joystick_msgs__msg__Joystick__init().
...
/**
 * It calls
 * my_joystick_msgs__msg__Joystick__fini()
...
my_joystick_msgs__msg__Joystick__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
 ...
 * my_joystick_msgs__msg__Joystick__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * my_joystick_msgs__msg__Joystick__Sequence__fini()
 * on the array,
...
#endif  // MY_JOYSTICK_MSGS__MSG__DETAIL__JOYSTICK__FUNCTIONS_H_
