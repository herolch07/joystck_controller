...
class Joystick(metaclass=Metaclass_Joystick):
    ...
    def __init__(self, **kwargs):
        ...
        self.lx = kwargs.get('lx', int())
        self.ly = kwargs.get('ly', int())
        self.rx = kwargs.get('rx', int())
        self.ry = kwargs.get('ry', int())
        self.dx = kwargs.get('dx', int())
        self.dy = kwargs.get('dy', int())
    ...
    def lx(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'lx' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'lx' field must be an integer in [-2147483648, 2147483647]"
        self._lx = value
    ...
    def ly(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'ly' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'ly' field must be an integer in [-2147483648, 2147483647]"
        self._ly = value
    ...
    def dx(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'dx' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'dx' field must be an integer in [-2147483648, 2147483647]"
        self._dx = value
    ...
    def dy(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'dy' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'dy' field must be an integer in [-2147483648, 2147483647]"
        self._dy = value
    ...
    def l2(self, value):
        if self._check_fields:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'l2' field must be an integer in [-2147483648, 2147483647]"
        self._l2 = value
    ...
    def r2(self, value):
        if self._check_fields:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'r2' field must be an integer in [-2147483648, 2147483647]"
        self._r2 = value
